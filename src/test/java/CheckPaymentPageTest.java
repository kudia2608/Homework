...
public class CheckPaymentPageTest extends BaseTest {
    ...
    public void paymentPageTest() {
        ...
        Assert.assertTrue(labelMasterCard.isDisplayed(), "Метка MasterCard не отображается");
        Assert.assertTrue(labelVisa.isDisplayed(), "Метка Visa не отображается");
        Assert.assertTrue(labelBelkard.isDisplayed(), "Метка Belkard не отображается");
        Assert.assertTrue(labelMir.isDisplayed(), "Метка Mir не отображается");
    }
}
